...
ray.get(model_pool.add_fixed.remote(name="qwen/qwen-turbo")) 
ray.get(model_pool.add_fixed.remote(name="meta-llama/llama-3.3-70b-instruct"))
ray.get(model_pool.add_fixed.remote(name="google/gemini-2.0-flash-001"))
