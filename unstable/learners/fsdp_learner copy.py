...
from safetensors.torch import safetensors, load_file as safe_load
...
def make_checkpoint_filter(percentage: float, block_class: type):
    def check_fn(module):
        ...
        if isinstance(module, block_class): # Only consider top-level blocks
            ...
            mod_fraction = (id(module) % 1000) / 1000.0  # Uniform(0,1)
...
class FSDPLearner:
    def __init__(
        ...
        if self.activation_checkpointing: 
            ...
            check_fn = make_checkpoint_filter(percentage=activation_ckpting_pct, block_class=transformers.models.qwen3.modeling_qwen3.Qwen3DecoderLayer)
